        ...
        <div id="nav">
            ...
            <a>
                <form class="search" action="/search" method="post">
                    <input class="sinput" placeholder="搜索标签" name="keyword"/>
                    <span class="sspan"></span>
                </form>
            </a>
            <a href="/write">写文章</a>
            <a href="/personal?value=${sessionScope.user.username}">${msg}${sessionScope.user.username}${msg1}</a>
                        ...
                        <div class="post">
                            <div>
                                ...
                                <div style=" height:60px;  line-height:60px; overflow:hidden;">
                                    <a href="/personal_?value=${article.author}">&nbsp;&nbsp;${article.author} </a>
                                </div>
                            </div>
                            ...
                            <div class="entry">
                                <p> ${article.summary} </p>
                                <p><a class="btn btn-primary btn-lg" href="detail?id=${article.id}"
                            ...
                            <ul>
                                <li>
                                    <div>
                                        ...
                                        <div style="display: inline;float: right;text-align: center;margin-top: 7px">
                                            <button class="attention1" value="关注" style="background-color: #00aaaa63">
                                                关注
                                            </button>
                                        </div>
                                ...
                                <li>
                                    <div>
                                        ...
                                        <div style="display: inline;float: right;text-align: center;margin-top: 7px">
                                            <button class="attention2" value="关注" style="background-color: #00aaaa63">
                                                关注
                                            </button>
                                        </div>
                                ...
                                <li>
                                    <div>
                                        ...
                                        <div style="display: inline;float: right;text-align: center;margin-top: 7px">
                                            <button class="attention3" value="关注" style="background-color: #00aaaa63">
                                                关注
                                            </button>
                                        </div>
